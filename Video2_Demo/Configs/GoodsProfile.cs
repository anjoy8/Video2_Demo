    ...
    public class GoodsProfile : Profile
    {
        ...
        public GoodsProfile()
        {
            ...
            CreateMap<GoodsEntity, GoodsDto>()
                ...
                // 合并
                .ForMember(dest => dest.GoodsName, opt => opt.MapFrom(src => src.BrandName +" "+ src.Name))
